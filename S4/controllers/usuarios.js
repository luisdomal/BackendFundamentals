...
function obtenerUsuarios(req, res) {
  ...
  var usuario1 = new Usuario(1, 'Juanin', 'Juan', 'Vega', 'juan@vega.com')
  var usuario2 = new Usuario(2, 'Monse', 'Monserrat', 'Vega', 'mon@vega.com')
  res.send([usuario1, usuario2])
}

function modificarUsuario(req, res) {
  // simulando un usuario previamente existente que el usuario utili
  var usuario1 = new Usuario(req.params.id, 'Juanin','Juan', 'Vega', 'juan@vega.com')
